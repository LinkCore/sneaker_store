  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      ...
      child: AlertDialog(
        ...
        title: Center(
          child: Text(
            '${S.current.edit} ${productNameController.text}',
        ...
        child: Row(
          ...
          Container(
            ...
            child: SelectPhotosWidget(
              onTap: (List<FileImage> indexes, List<File> picturesFile) {
                setState(() {
          ...
          TextButton(
            onPressed: () async {
              UIBlock.block(context, customLoaderChild: const CircularProgressIndicator(color: Colors.amber));
              Product newProduct = Product(
                ...
                imagesUrls: await ProductRepository().uploadImages(
                    widget.product.id!, oldFiles: widget.imagesList!, newFiles: selectedPicturesBase64),
              );
