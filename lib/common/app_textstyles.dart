...
class AppTextStyles {
  static TextStyle buttonTextStyle = GoogleFonts.poppins(color: AppColors.backgroundColor, fontWeight: FontWeight.w600, fontSize: 18);
  static TextStyle gridCountPriceTextStyle = GoogleFonts.poppins(color: AppColors.backgroundColor, fontWeight: FontWeight.w800, fontSize: 15);
  ...
  static TextStyle questionTitleTextStyle = GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w400);
  static TextStyle tappedTextStyle = GoogleFonts.poppins(color: Colors.blue, fontWeight: FontWeight.w600);
  static TextStyle alertApproveTextStyle = GoogleFonts.poppins(color: Colors.amber, fontWeight: FontWeight.w700);
